...
<body>
    ...
    <div class="phuden" id="phuden">
            ...
            <div class="VDT" id="VMH" value="aaaaa" style=" margin-top: 70px;background-color: coral; display: block;"> <a href="phanloai.php" style="color: black;" > Váy Mùa Hè   </a></div>         
        ...
        <div class="tenvay" >
                ...
                <div class="Name"  >
                    ...
                    <div class="pl_vay" id="pl_vay" style=" margin-top: 20px; ">
                     ...
                     <a href="phanloai.php" style="color: #FF4500;"> Váy Mùa Hè   </a>
                     <div id='vayMH'> </div>
                    </div>
                    ...
                    <div class="pl_vay" id="pl_vay"> <a href="phanloaiTui.php" style="color: black;">Túi  </a>
                    <div id='vayMH'> </div>
                </div>
