<?php
    ...
    $sql = "SELECT * FROM sql_chanvay where Stt = $Stt ";
    
    $query = mysqli_query($connet , $sql);

    $sql_test = "SELECT * FROM sql_chanvay where Stt = $Stt ";
    
    $query_test = mysqli_query($connet , $sql_test);
   
    $sqlAll = "SELECT * FROM sql_chanvay where Stt < 6";
    
    $queryAll = mysqli_query($connet , $sqlAll);

    
    $sqlCT = "SELECT * FROM sql_chitietchanvay where Stt = $Stt ";
