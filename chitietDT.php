<?php
    ...
    $sql = "SELECT * FROM sql_vaydutiec where Stt = $Stt ";
    
    $query = mysqli_query($connet , $sql);

    $sql_test = "SELECT * FROM sql_vaydutiec where Stt = $Stt ";
    
    $query_test = mysqli_query($connet , $sql_test);
   
    $sqlAll = "SELECT * FROM sql_vaydutiec where Stt < 6";
    
    $queryAll = mysqli_query($connet , $sqlAll);

    
    $sqlCT = "SELECT * FROM sql_chitietvaydutiec where Stt = $Stt ";
                 ...
                 <img style="width: 500px; height: 500px; margin-left: 450px; margin-top:200px;" id="img" src = './img/<?php echo $img = $row['img'] ?>  '/>
                    ...
                    <td class="td_left" style="display: block" >
                        ...
                        <div id="box_soluong">
                            ...
                            <div class="soluong "  style="font-size: 20px;">Số Lượng </div>
                        ...
                        <input type="hidden" name="tensp" value="<?=$Ten=$row['TenVay'] ?>">
