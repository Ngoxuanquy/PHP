<?php
      ...
      if(isset($_COOKIE['pass']) ){
          ...
          $sql = "SELECT * FROM sql_chanvay ";
          $query = mysqli_query($connet , $sql);
  
         
          $sql6 = "SELECT * FROM sql_chanvay where Stt > '5'";
...
<body>
    ...
    <b><span id="position"></span></b> 
        ...
        <div class="Name"  >
                   ...
                   <div class="pl_vay" id="pl_vay"> <a href="phanloaiChanVay.php" style="color: #FF4500;">Chân Váy  </a>
