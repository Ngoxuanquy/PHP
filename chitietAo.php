<?php
    ...
    $sql = "SELECT * FROM sql_ao where Stt = $Stt ";
    
    $query = mysqli_query($connet , $sql);

    $sql_test = "SELECT * FROM sql_ao where Stt = $Stt ";
    
    $query_test = mysqli_query($connet , $sql_test);
   
    $sqlAll = "SELECT * FROM sql_ao where Stt < 6";
    
    $queryAll = mysqli_query($connet , $sqlAll);

    
    $sqlCT = "SELECT * FROM sql_chitietAo where Stt = $Stt ";
