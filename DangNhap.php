...
require_once("./db.php"); 
   ...
   $test =  mysqli_query($connet , $sqlCT);
    ...
    while($row = mysqli_fetch_assoc($test)) {?>
        ...
        if( $tenDN == $gmail  && $MK ==  $pas && $MK != ''){
       $ten = $row['ten'];
    
        header("Location: index.php");
      }
      //  else{
      //       //  echo '<script>  alert("Bạn Chưa có tài khoản !!"); </script>';
      // }
        ?>
        <?php } 
...
<form action="" method="post" class="form"> <br><br><br><br><br>
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="DangKy.php">Forgot Password?</a>
    </div>
