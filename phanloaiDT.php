<?php
      ...
      if(isset($_COOKIE['pass']) ){
          ...
          $sql = "SELECT * FROM sql_vaydutiec ";
          $query = mysqli_query($connet , $sql);
  
         
          $sql6 = "SELECT * FROM sql_vaydutiec where Stt > '5'";
...
<body>
    ...
    <b><span id="position"></span></b> 
        ...
        <div class="Name"  >
                   ...
                   <div class="pl_vay" id="pl_vay"> <a href="phanloaiDT.php" style="color: #FF4500;">Váy Dự Tiệc   </a>
                   <div id='vayMH'> </div>
               </div>
